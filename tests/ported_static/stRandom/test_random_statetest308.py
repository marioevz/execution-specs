...
def test_random_statetest308(
    ...
    contract_0 = pre.deploy_contract(  # noqa: F841
        ...
        + Op.CALLDATALOAD(
            offset=Op.PUSH32[0x945304EB96065B2A98B57A48A06AE28D285A71B5]
        )
        + Op.SSTORE(
    ...
    tx = Transaction(
        ...
        to=contract_0,
        data=Bytes(
            ""  # noqa: E501
        ),
