...
def test_random_statetest418(
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0xB3CEB9E1CE94D2E429039525E57315F4BD255F06),  # noqa: E501
    )
    # Source: raw
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        gas_limit=392462029,
        value=0x65A87A48,
    )
